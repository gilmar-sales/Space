...
SpawnSystem::SpawnSystem(const Ref<fr::Scene> &scene, const Ref<AssetManager> &assetManager,
    ...
    mScene->CreateArchetypeBuilder()
            ...
            .ForEach<TransformComponent, SphereColliderComponent, RigidBodyComponent>(
                [this](TransformComponent &transform, SphereColliderComponent &sphereCollider,
                    ...
                    transform = {
                        .position = mRandom->Position(-100'000, 100'000),
    ...
    mScene->CreateArchetypeBuilder()
            ...
            .WithComponent(ModelComponent{
                .meshes = &mAssetManager->GetJupiterModel(),
    ...
    mScene->CreateArchetypeBuilder()
            ...
            .WithComponent(
                ModelComponent{
                    .meshes = &mAssetManager->GetRock1Model(), .material = mAssetManager->GetRock1Material()
                })
            .WithComponent(
    ...
    mScene->CreateArchetypeBuilder()
            ...
            .WithComponent(
                ModelComponent{
                    .meshes = &mAssetManager->GetRock2Model(), .material = mAssetManager->GetRock2Material()
                })
            .WithComponent(TransformComponent{
                .position = glm::vec3(0),
                .rotation = glm::vec3(0.0),
    ...
    mScene->CreateArchetypeBuilder()
            ...
            .WithComponent(HealthComponent{.hitPoints = 1000})
            .WithComponent(ModelComponent{
                .meshes = &mAssetManager->GetPlayerShipModel(),
                .material = mAssetManager->GetPlayerShipMaterial()
            })
            .WithComponent(
                TransformComponent{
                    .position = mRandom->Position(-SPAWN_RANGE, SPAWN_RANGE),
            ...
            .WithComponent(
                LaserGunComponent{
                    .fireRate = 0.05f, .fireTime = 0, .energyCost = 5, .energySpent = 0, .maxEnergy = 100
                })
            .WithEntities(1)
            .Build();
    ...
    mScene->CreateArchetypeBuilder()
            ...
            .WithComponent(HealthComponent{.hitPoints = 1000})
            .WithComponent(ModelComponent{
                .meshes = &mAssetManager->GetEnemyShipModel(),
